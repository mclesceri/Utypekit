		...
		new Ajax.Request(url,{
			...
			onSuccess: function(transport) {
				...
				if(parsed.status == 'true') {
					...
					$('feedback').update('<span style="color: red">' + parsed.message + 'If you have lost your login information, <a href="lost_password.php">click here</a>. If you believe you have received this message in error, <a href="http://www.cookbookpublishers.com/contact/">contact Cookbook Publishers Inc</a>.</span>');
				}
			}
		});
	} else {
