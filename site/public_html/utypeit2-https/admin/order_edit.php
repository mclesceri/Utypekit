...
function getContractors($order_id) {
	$newPeople = new People();
	$result = $newPeople->sendAndGetMany('SELECT People.id,People.first_name,People.last_name,People.email FROM People,Orders_Contractors WHERE Orders_Contractors.order_id="'.$order_id.'" AND People.id=Orders_Contractors.contractor_id ORDER BY id DESC');
	return( $result );
}
...
$script = "
        ...
        function userWin() {
			window.open('users_edit.php','_blank','scrollbars=1,status=0,toolbar=0,menubar=0,resizeable=0,location=0,height=400,width=600');
		}
		...
		document.observe('dom:loaded',function() {
			...
			$('recipes_continued_yes').observe('click', function(event){
				$('use_fillers_yes').writeAttribute('class','disabled');
				$('use_fillers_yes').disable();
				$('use_fillers_no').writeAttribute('class','disabled');
				$('use_fillers_no').disable();
				$('filler_type').writeAttribute('class','disabled');
				$('filler_type').disable();
				$('filler_type').selectedIndex=0;
				$('filler_set').writeAttribute('class','disabled');
				$('filler_set').disable();
			...
			$('use_fillers_yes').observe('click', function(event){
				if($('filler_type').hasAttribute('disabled')) {
					$('filler_type').toggleClassName('disabled','enabled');
					$('filler_type').removeAttribute('disabled');
					$('filler_set').toggleClassName('disabled','enabled');
					$('filler_set').removeAttribute('disabled');
				}
			});
				
			$('use_fillers_no').observe('click', function(event){
				$('filler_type').toggleClassName('disabled','enabled');
				$('filler_type').setAttribute('disabled','disabled');
				$('filler_type').selectedIndex=0;
				$('filler_set').toggleClassName('disabled','enabled');
				$('filler_set').setAttribute('disabled','disabled');
				$('filler_set').selectedIndex=0;
			});
...
$out = '
<div class="order_edit_save">
	<button type="submit" onclick="makeOrder('.$order_id.'); return false;" style="float: left">Generate Form</button>';
	if($_SESSION['user']->level > 6) {
		if($_SESSION['user']->level > 7) {
			$out .= '<button type="submit" onclick="sendOrder(\'delete\'); return false;">Delete Order</button><span style="display: inline-block; width: 50px;">&nbsp;</span>';
		}
		$out .= '<button type="submit" onclick="sendOrder(\''.$action.'\'); return false;">Save Order</button>';
	}
$out .='</div>';
...
<form id="order_edit" name="order_edit">
    ...
    <input type="hidden" name="action" id="action" value="'.$function.'">';
if($action == 'order_edit') {
    ...
    $out .= '
    <input type="hidden" name="added_by_type" value="2">
...
<div id="general" class="orderOption">
    <table>
        ...
        <tr>
            ...
            <td class="formLabel even b-right b-bottom"><a href="'.HELP.'order_status.html" title="Order Status" class="lightwindow help">?</a></td>
        </tr>
        <tr>
            ...
            <td class="formLabel odd b-right b-bottom"><a href="'.HELP.'order_title.html" title="Order Title" class="lightwindow help">?</a></td>
            ...
            <td class="formLabel odd b-right b-bottom"><a href="'.HELP.'order_number.html" title="Order Number" class="lightwindow help">?</a></td>
        </tr>
        <tr>
            <td class="formLabel even b-left">Book Title:</td>
            <td class="formInput even" rowspan="3">
                <input name="book_title1" id="book_title1" value="'.$book_title1.'" type="text" maxlength="36"><br />
                <input name="book_title2" id="book_title2" value="'.$book_title2.'" type="text" maxlength="36" style="margin-top: 5px"><br />
                <input name="book_title3" id="book_title3" value="'.$book_title3.'" type="text" maxlength="36" style="margin-top: 5px">
            </td>
            <td class="formLabel even b-right"><a href="'.HELP.'cookbook_title.html" title="Book Title" class="lightwindow help">?</a></td>
            ...
            <td class="formLabel even b-right b-bottom"><a href="'.HELP.'book_style.html" title="Book Style" class="lightwindow help">?</a></td>
        </tr>
        <tr>
            <td class="even b-left">&nbsp;</td>
            ...
            <td class="formSubmit odd b-right b-bottom"><a href="'.HELP.'book_count.html" title="Number of Books" class="lightwindow help">?</a></td>
        </tr>
        <tr>
...
<div id="users" class="orderOption" style="display: none;">
    <table>
        <tr>
            ...
            if($action == 'order_edit') {
            	$out .= '
            Current Users for Order #'.$_SESSION['order_number'].' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" onclick="userWin(); return false;">Edit Users</a>';
            } else {
            	$out .= '
            	&nbsp;';
            }
        ...
        <tr>
        	<td colspan="2"><strong>Contractor(s)</strong></td>
        </tr>';
        if($order_id) {
	        $contractors = getContractors($order_id);
	        $count = 0;
		...
		<tr>
			...
			<input type="hidden" name="person_'.($count + 1).'" value="'.$c->id.'">
			<td class="formInput '.$class.' b-bottom">'.stripslashes(urldecode($c->first_name)).' '.stripslashes(urldecode($c->last_name)).'</td>
		...
		<tr>
			...
			<td class="formInput '.$class.' b-bottom"><a href="people_edit.php?id='.$u->id.'&action=customers_edit">'.stripslashes(urldecode($u->first_name)).' '.stripslashes(urldecode($u->last_name)).'</a></td>
			<td class="formInput '.$class.' b-bottom">';
			...
			$out .= '
		<tr>
			<td>Users can be added to the order AFTER the order has been set up.</td>
		</tr>';
		}
		$out .= '
	</table>
...
<div id="page" class="orderOption" style="display: none;">
    <table>
        ...
        $out .= '
        <tr>
            <td class="formLabel odd b-left b-bottom">FREE Nutritionals Pages?</td>
            ...
            <td class="odd b-right b-bottom"><a href="'.HELP.'nutritionals.html" title="Nutritionals Page" class="lightwindow help">?</a></td>
        </tr>';
        $yes_checked = '';
        $no_checked = '';
        ...
        <tr>
            ...
            <td class="formInput even b-bottom centsaver"><input class="usub" id="use_subcategories_yes" name="use_subcategories" value="yes" type="radio"'.$yes_checked.'>Yes &nbsp;<input class="usub" id="use_subcategories_no" name="use_subcategories" value="no" type="radio"'.$no_checked.'> No</td>
            <td class="even b-right b-bottom"><a href="'.HELP.'use_subcategories.html" title="Subcategories" class="lightwindow help">?</a></td>
        </tr>';
        $yes_checked = '';
        $no_checked = '';
        if($contributors == 'yes') {
        ...
        <tr>
            ...
            <td class="even b-right b-bottom"><a href="'.HELP.'contributors_index.html" title="Contributors Page" class="lightwindow help">?</a></td>
        </tr>
        <tr>
            <td class="formLabel odd b-left b-bottom" style="vertical-align: top; padding-top: 5px">Order the index page by:</td>
            ...
            <td class="odd b-right b-bottom"><a href="'.HELP.'order_index_by.html" title="Recipe Index" class="lightwindow help">?</a></td>
        </tr>';
        $yes_checked = '';
        $no_checked = '';
        ...
        <tr>
            ...
            <td class="even b-right b-bottom"><a href="'.HELP.'order_form.html" title="Order Form" class="lightwindow help">?</a></td>
        </tr>';
        ...
        <tr id="order_form_tr"'.$display.'>
            ...
            <table style="width: 600px">
                ...
                <tr>
                    ...
                    <td class="formInput"><input name="order_form_retail" id="order_form_retail" value="'.$order_form_retail.'" type="text"></td>
                    <td class="formLabel">Shipping Fee:</td>
                    <td class="formInput"><input name="order_form_shipping" id="order_form_shipping" value="'.$order_form_shipping.'" type="text"></td>
                </tr>
            </table>
            </td>
        </tr>
...
<div id="design" class="orderOption" style="display: none;">
    <table>
        ...
        <tr>
            <td class="formLabel odd b-left b-bottom">Order Recipes: </td>
            <td class="formInput odd b-bottom">
            ...
            <td class="odd b-right b-bottom"><a href="'.HELP.'order_recipes_by.html" title="Organize Recipes" class="lightwindow help">?</a></td>
            <td class="formLabel odd b-bottom">Recipes Continued:</td>
            <td class="formInput odd b-bottom">';
            $radio_set = array('yes'=>'Yes','no'=>'No');
            if(!$recipes_continued) {
                $recipes_continued = 'no';
            }
            foreach($radio_set AS $key=>$val) {
                if($recipes_continued == $key) {
                    $checked = "checked='checked'";
                } else {
                    $checked = '';
                }
                $out .= "<input type='radio'".$checked." name='recipes_continued' id='recipes_continued_".$key."' value='".$key."'>&nbsp;".$val."&nbsp;";
            }
            $out .= '</td>
            <td class="odd b-right b-bottom"><a href="'.HELP.'recipes_continued.html" title="Recipes Continued" class="lightwindow help">?</a></td>
        </tr>
        <tr>
            ...
            $out .= '</td>
            <td class="even b-right b-bottom"><a href="'.HELP.'allow_notes.html" title="Allow Recipe Notes" class="lightwindow help">?</a></td>
            <td class="formLabel even b-left b-bottom">Use Icons:</td>
            <td class="formInput even b-bottom">';
            $radio_set = array('yes'=>'Yes','no'=>'No');
            foreach($radio_set AS $key=>$val) {
                if($key == $use_icons) {
                ...
                $out .= "<input type='radio'".$checked." name='use_icons' id='use_icons".$key."' value='".$key."'>&nbsp;".$val."&nbsp;";
            }
            $out .= '</td>
            <td class="even b-right b-bottom"><a href="'.HELP.'use_icons.html" title="Use Recipe Icons" class="lightwindow help">?</a></td>
        </tr>
        <!--<tr>
            <td class="formLabel odd b-bottom">Design Type:</td>
            <td class="formInput odd b-bottom">
            ...
            <td class="odd b-right b-bottom"><a href="'.HELP.'design_type.html" title="Design Type" class="lightwindow help">?</a></td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
        </tr>/-->
        <tr>
            ...
            $out .= '</td>
            <td class="odd b-right b-bottom"><a href="'.HELP.'use_fillers.html" title="Page Fillers" class="lightwindow help">?</a></td>
        ...
        <tr>
            ...
            <td class="formInput even b-bottom" id="filler_set_td">
                    ';
                    $disabled = (string) '';
                    $options = (string) '';
                    if($use_fillers == 'no') {
            ...
            <td class="even b-right b-bottom">&nbsp;</td>
            <td class="formInput even b-right b-bottom" colspan="3"><a href="#" onclick="popWin(\'filler_sets\')" class="lightwindow help" style="width: 120px;">Show Filler Sets</a></td>
        </tr>
    </table>
        ...
        foreach($format_array->format AS $a) {
            ...
            $out .= '
                <div class="format">
                    ...
                    <p>'.$a->description.' <input type="radio" name="recipe_format" value="'.$a->name.'" onclick="setRecipeFormat(event)" flag="'.$a->flag.'"'.$checked.' /></p>
                </div>';
        }
        $out .= '
         </div>
