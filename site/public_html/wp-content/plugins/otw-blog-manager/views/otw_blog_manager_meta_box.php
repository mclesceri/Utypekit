<?php
	$selectOptionData = array(
		...
		array(
			'value'	=> 'youtube',
			'text'	=> __('YouTube', 'otw_bm')
		),
		array(
			'value'	=> 'vimeo',
			'text'	=> __('Vimeo', 'otw_bm')
		),
		array(
			'value'	=> 'soundcloud',
			'text'	=> __('Sound Cloud', 'otw_bm')
		),
		// array(
		// 	'value'	=> 'media',
		// 	'text'	=> __('Video', 'otw_bm')
		// ),
		// array(
		// 	'value'	=> 'audio',
		// 	'text'	=> __('Audio', 'otw_bm')
		// ),

		array(
			'value'	=> 'img',
			'text'	=> __('Image', 'otw_bm')
		),
		array(
			'value'	=> 'slider',
			'text'	=> __('Slider', 'otw_bm')
		)
	);
...
<table class="form-table">
	<tbody>
		<!-- Select Drop Down -->
		<tr valign="top">
			<th scope="row"><label for="media_type"><?php _e('Choose Media Type', 'otw_bm');?></label></th>
			<td>
		...
		<tr valign="top" class="js-meta-youtube <?php echo $youtube;?>">
			<th scope="row"><label for="youtube_url"><?php _e('Enter YouTube URL', 'otw_bm');?></label></th>
			<td>
		...
		<tr valign="top" class="js-meta-vimeo <?php echo $vimeo;?>">
			<th scope="row"><label for="vimeo_url"><?php _e('Enter Viemo URL', 'otw_bm');?></label></th>
			<td>
		...
		<tr valign="top" class="js-meta-soundcloud <?php echo $soundcloud;?>">
			<th scope="row"><label for="soundcloud_url"><?php _e('Enter SoundCloud URL', 'otw_bm');?></label></th>
			<td>
...
<!-- 		<tr valign="top" class="js-meta-media <?php echo $media_display;?>">
			<th scope="row"><label for="media_url"><?php _e('Select Video File', 'otw_bm');?></label></th>
			<td>
				<input type="hidden" id="media_url" name="otw-bm-list-media_url" class="js-otw-media-url" value="<?php echo $media_url; ?>" size="53"/>
				<a href="#" class="js-add-media"><?php _e('Select Audio File', 'otw_bm');?></a>
				<p class="description"><?php _e('Note: At this time WordPress will support only MP4 files for native embededing', 'otw_bm');?></p>
			</td>
		</tr> -->

		<!-- Single Image -->
		<tr valign="top" class="js-meta-image <?php echo $img;?>">
			<th scope="row"><label for="img_upload"><?php _e('Select File', 'otw_bm');?></label></th>
			<td>
				<a href="#" class="js-add-image"><?php _e('Add File', 'otw_bm');?></a>
		...
		<tr valign="top" class="js-meta-slider <?php echo $slider;?>">
			<th scope="row"><label for="slider"><?php _e('Slider Images', 'otw_bm');?></label></th>
			<td>
				<a href="#" class="js-add-image left"><?php _e('Add File', 'otw_bm');?></a><br/>
