...
<aside class="otw-twentyfour otw-columns otw_blog_manager-sidebar otw-bm-list-section" id="otw-bm-list-<?php echo $this->listOptions['id'];?>">
  <ul class="bm_clearfix">
    <li class="widget otw_blog_manager-widget-carousel bm_clearfix">
      <div class="otw_blog_manager-slider otw_blog_manager-carousel flex-viewport" data-type="widget" data-animation="slide" data-item-per-page="2" data-item-margin="10" data-nav="<?php echo $this->listOptions['slider_nav'];?>" data-auto-slide="<?php echo $this->listOptions['slider-auto-scroll'];?>">
        <ul class="slides">
          <?php
