<!-- Blog 4 Columns -->
<section class="otw-twentyfour otw-columns otw-blog-4-column-news otw-bm-list-section" id="otw-bm-list-<?php echo $this->listOptions['id'];?>">
  ...
  ?>
    ...
    <div class="otw-six otw-columns otw_blog_manager-blog-newspaper-item <?php echo $categoriesString;?>">
