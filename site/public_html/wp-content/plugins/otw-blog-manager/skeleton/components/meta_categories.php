...
<div class="otw_blog_manager-blog-category">
  ...
  <span class="head"><?php _e('Category:', OTW_TRANSLATION);?></span>
  <?php else: ?>
  ...
  ?>
  <a href="<?php echo esc_url($catUrl);?>" rel="category" title="<?php _e('View all posts in ', OTW_TRANSLATION); echo $category->name;?>">
