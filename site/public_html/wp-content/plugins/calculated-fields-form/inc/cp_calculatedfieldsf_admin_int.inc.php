...
<div id="normal-sortables" class="meta-box-sortables">
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
     ...
     ?></div>
	 <input type="hidden" name="form_structure" id="form_structure" value="<?php print esc_attr(preg_replace('/&quot;/i', '&amp;quot;', json_encode(cp_calculatedfieldsf_get_option( 'form_structure', CP_CALCULATEDFIELDSF_DEFAULT_form_structure )))); ?>" />
     ...
     <link href="<?php echo plugins_url('../css/style.css', __FILE__); ?>" type="text/css" rel="stylesheet" property="stylesheet" />
     <link href="<?php echo plugins_url('../css/cupertino/jquery-ui-1.8.20.custom.css', __FILE__); ?>" type="text/css" rel="stylesheet" property="stylesheet" />
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
     <table class="form-table">
        ...
        <?php _e( '- For general CSS styles modifications to the form and samples <a href="http://cff.dwbooster.com/faq#q82" target="_blank">check this FAQ</a>.', 'calculated-fields-form' ); ?></td>
		</tr>
        <?php
 ...
 <div id="metabox_basic_settings" class="postbox">
  ...
  <div class="inside">
    ...
    <table class="form-table">
        ...
        <td><input type="text" name="enable_paypal_option_no" size="40" style="width:250px;"  value="<?php echo esc_attr(cp_calculatedfieldsf_get_option('enable_paypal_option_no',CP_CALCULATEDFIELDSF_PAYPAL_OPTION_NO)); ?>" /></th>
        </th>
  ...
  <div class="inside">
    ...
    <table class="form-table">
        ...
        <td><select name="enable_paypal" onchange="cff_update_pp_payment_selection();">
             ...
             <option value="2" <?php if (cp_calculatedfieldsf_get_option('enable_paypal',CP_CALCULATEDFIELDSF_DEFAULT_ENABLE_PAYPAL) == '2') echo 'selected'; ?> ><?php _e( 'Optional: This payment method + Pay Later', 'calculated-fields-form' ); ?></option>
            </select>
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
     <table class="form-table">
        ...
        <td>
			<select id="cu_user_email_field" name="cu_user_email_field[]" def="<?php echo esc_attr(cp_calculatedfieldsf_get_option('cu_user_email_field', CP_CALCULATEDFIELDSF_DEFAULT_cu_user_email_field)); ?>" MULTIPLE></select><br/>
			<em>
...
[<a href="http://cff.dwbooster.com/customization" target="_blank"><?php _e( 'Request Custom Modifications', 'calculated-fields-form' ); ?></a>] | [<a href="http://cff.dwbooster.com/" target="_blank"><?php _e( 'Help', 'calculated-fields-form' ); ?></a>]
</form>
</div>
<script type="text/javascript">
	...
	function cff_update_pp_payment_selection()
	{
	   var 	f = document.cpformconf,
			ppoption = f.enable_paypal.options[f.enable_paypal.selectedIndex].value;
